...
\begin{document}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html2,Rotate=1.2 ,Title={ Registro de Miembros},FontTitle={\bfseries\itshape}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html3,Rotate=0.8 ,Title={ Gestión de Pagos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html4,Rotate=0.2 ,Title={ Seguimiento Administrativo},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html5,Rotate=1.5 ,Title={ Gestión de Empleados y Horarios},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html6,Rotate=-1.5 ,Title={ Control de Acceso y Permisos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html7,Rotate=-2.2 ,Title={ Integración con Otros Sistemas},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html8,Rotate=2 ,Title={ Facilidad de Uso y Soporte Técnico},FontTitle={\bfseries\itshape}
	...
	\begin{landscape}
		...
		\begin{adjustbox}
			{max size={0.9\textwidth}{0.9\textheight}} \scalebox{3}{
			...
			\begin{ganttchart}
				...
				canvas/.style={ draw=black, dotted } ]{2024-09-09}{2024-09-12}
