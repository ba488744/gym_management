...
\begin{document}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html5,Rotate=-1.4 ,Title={ Gestión de Empleados y Horarios},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html6,Rotate=0.5 ,Title={ Control de Acceso y Permisos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html7,Rotate=1.7 ,Title={ Integración con Otros Sistemas},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html8,Rotate=0.6 ,Title={ Facilidad de Uso y Soporte Técnico},FontTitle={\bfseries\itshape}
