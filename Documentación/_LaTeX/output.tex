...
\begin{document}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html2,Rotate=2.3 ,Title={ Registro de Miembros},FontTitle={\bfseries\itshape}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html3,Rotate=-0.2 ,Title={ Gestión de Pagos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html4,Rotate=0.7 ,Title={ Seguimiento Administrativo},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html5,Rotate=-0.6 ,Title={ Gestión de Empleados y Horarios},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html6,Rotate=2.9 ,Title={ Control de Acceso y Permisos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html7,Rotate=-0.2 ,Title={ Integración con Otros Sistemas},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html8,Rotate=0.4 ,Title={ Facilidad de Uso y Soporte Técnico},FontTitle={\bfseries\itshape}
	...
	\begin{landscape}
		...
		\scalebox{0.9}{%\begin{adjustbox}{max size={0.9999\textwidth}{0.9999\textheight}}
		...
		\begin{ganttchart}
			...
			canvas/.style={ draw=black, dotted } ]{2024-09-09}{2024-09-22}
			...
			\ganttset{ bar/.append style={ pattern=dots }, } \ganttgroup[progress=16.666667]{Análisis de requerimientos}{2024-09-09}{2024-09-12}
			\\ \ganttset{ bar/.append style={ pattern=dots }, } \ganttbar[progress=30]{Entrevista al responsable del gym.}{2024-09-09}{2024-09-09}
			\\ \ganttset{ bar/.append style={ pattern=crosshatch dots }, } \ganttlinkedbar[progress=20]{Identificación de User Stories (US).}{2024-09-10}{2024-09-11}
			\\ \ganttset{ bar/.append style={ pattern=horizontal lines }, }
			\ganttlinkedbar[progress=0]{Priorización de las US más relevantes e importantes.}{2024-09-11}{2024-09-12}
			\\ \ganttset{ bar/.append style={ pattern color=html3 }, group/.append style={ draw=black, fill=html3 }, milestone/.append style={ fill=html3 }, }
			\ganttset{ bar/.append style={ pattern=dots }, } \ganttgroup[progress=0]{Etapa de diseño}{2024-09-12}{2024-09-22}
			\\ \ganttset{ bar/.append style={ pattern=dots }, } \ganttbar[progress=0]{Diagrama de casos de uso}{2024-09-12}{2024-09-16}
			\\ \ganttset{ bar/.append style={ pattern=crosshatch dots }, } \ganttbar[progress=0]{diagrama de secuencia}{2024-09-13}{2024-09-17}
			\\ \ganttset{ bar/.append style={ pattern=horizontal lines }, } \ganttbar[progress=0]{Diagrama de actividades}{2024-09-17}{2024-09-19}
			\\ \ganttset{ bar/.append style={ pattern=vertical lines }, } \ganttbar[progress=0]{Diagrama de componentes}{2024-09-18}{2024-09-22}
