...
\begin{document}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html2,Rotate=-0.6 ,Title={ Registro de Miembros},FontTitle={\bfseries\itshape}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html3,Rotate=-2.9 ,Title={ Gestión de Pagos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html4,Rotate=-2.5 ,Title={ Seguimiento Administrativo},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html5,Rotate=1.2 ,Title={ Gestión de Empleados y Horarios},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html6,Rotate=1 ,Title={ Control de Acceso y Permisos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html7,Rotate=-1.1 ,Title={ Integración con Otros Sistemas},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html8,Rotate=-0.9 ,Title={ Facilidad de Uso y Soporte Técnico},FontTitle={\bfseries\itshape}
	...
	\begin{adjustbox}
		...
		\begin{ganttchart}
			...
			canvas/.style={ draw=black, dotted } ]{2024-09-12}{2024-09-17}
			...
			\\ \ganttset{ bar/.append style={ pattern=dots }, } \ganttbar[progress=100]{Introducción \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html1}{ \textbf{ Magaly}} }}}{2024-09-12}{2024-09-17}
			\\ \ganttset{ bar/.append style={ pattern=crosshatch dots }, } \ganttbar[progress=100]{Planteamiento del problema \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html1}{ \textbf{ Monserrat}} }}}{2024-09-12}{2024-09-17}
			\\ \ganttset{ bar/.append style={ pattern=horizontal lines }, } \ganttbar[progress=100]{Objetivo general \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html1}{ \textbf{ Cristian}} }}}{2024-09-12}{2024-09-17}
			\\ \ganttset{ bar/.append style={ pattern=vertical lines }, } \ganttbar[progress=100]{Objetivos específicos \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html1}{ \textbf{ Aimar Jair}} }}}{2024-09-12}{2024-09-17}
			\\ \ganttset{ bar/.append style={ pattern=grid }, } \ganttbar[progress=100]{Justificación \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html1}{ \textbf{ Gerardo}} }}}{2024-09-12}{2024-09-17}
			\\ \ganttset{ bar/.append style={ pattern=north west lines }, } \ganttbar[progress=100]{Alcances y limitaciones \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html1}{ \textbf{ Valentín}} }}}{2024-09-12}{2024-09-17}
			\\
		\end{ganttchart}
		}
	\end{adjustbox}
	...
	\begin{adjustbox}
		...
		\begin{ganttchart}
			...
			shortcut=true, group label node/.append style={align=right}, bar label
			node/.append style={align=right}, milestone label node/.append style={align=right},
			canvas/.style={ draw=black, dotted } ]{2024-09-18}{2024-09-24}
			...
			\ganttset{ bar/.append style={ pattern=dots }, } \ganttgroup[progress=0]{Marco Teórico}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=dots }, } \ganttbar[progress=0]{Análisis de requerimientos \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Gerardo}} }}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=crosshatch dots }, } \ganttbar[progress=0]{Diseño de vistas \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Magaly}} , \textcolor{html2}{ \textbf{ Monserrat}} }}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=horizontal lines }, } \ganttbar[progress=0]{Diseño conceptual \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Aimar Jair}} }}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=vertical lines }, } \ganttbar[progress=0]{Análisis de entidades \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Valentín}} }}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=grid }, } \ganttbar[progress=0]{Análisis funcional \ganttalignnewline \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Cristian}} }}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ ,vrule offset =0.666667,} \ganttvrule{HOY}{\the\year-\the\month-\the\day}
		\end{ganttchart}
		}
	\end{adjustbox}
\end{document}