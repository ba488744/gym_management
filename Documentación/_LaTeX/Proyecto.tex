...
\begin{document}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html2,Rotate=0.3 ,Title={ Registro de Miembros},FontTitle={\bfseries\itshape}
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html4,Rotate=-0.3 ,Title={ Seguimiento Administrativo},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html5,Rotate=2.9 ,Title={ Gestión de Empleados y Horarios},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html6,Rotate=0.6 ,Title={ Control de Acceso y Permisos},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html7,Rotate=-1 ,Title={ Integración con Otros Sistemas},FontTitle={\bfseries\itshape}
			] Como \textbf{administrador},
	...
	\begin{minipage}{0.498\linewidth}
		\noindent
		\begin{PostItNote}
			[Width=0.9\linewidth,Corner=true,Pin=None,Color=html8,Rotate=0.8 ,Title={ Facilidad de Uso y Soporte Técnico},FontTitle={\bfseries\itshape}
	...
	\begin{adjustbox}
		...
		\begin{ganttchart}
			...
			\\ \ganttset{ bar/.append style={ pattern=dots }, } \ganttbar[progress=0]{\raisebox{-0.075cm}{ Análisis de requerimientos } \ganttalignnewline \raisebox{0.15cm}{ \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Gerardo}} }}}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=crosshatch dots }, } \ganttbar[progress=0]{\raisebox{-0.075cm}{ Diseño de vistas } \ganttalignnewline \raisebox{0.15cm}{ \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Magaly}} , \textcolor{html2}{ \textbf{ Monserrat}} }}}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=horizontal lines }, } \ganttbar[progress=0]{\raisebox{-0.075cm}{ Diseño conceptual } \ganttalignnewline \raisebox{0.15cm}{ \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Aimar Jair}} }}}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=vertical lines }, } \ganttbar[progress=0]{\raisebox{-0.075cm}{ Análisis de entidades } \ganttalignnewline \raisebox{0.15cm}{ \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Valentín}} }}}}{2024-09-18}{2024-09-24}
			\\ \ganttset{ bar/.append style={ pattern=grid }, } \ganttbar[progress=0]{\raisebox{-0.075cm}{ Análisis funcional } \ganttalignnewline \raisebox{0.15cm}{ \footnotesize{ \textit{ \textcolor{gray}{ Responsable(s): } \textcolor{html2}{ \textbf{ Cristian}} }}}}{2024-09-18}{2024-09-24}
			\ganttset{ ,vrule offset =0.625,} \ganttvrule{HOY}{\the\year-\the\month-\the\day}
		\end{ganttchart}
		}
	\end{adjustbox}
\end{document}